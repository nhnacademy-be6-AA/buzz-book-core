...
//
// 		when(paymentService.order(any(JSONObject.class))).thenReturn(expectedResponse);
//
...
// 			.andExpect(status().isOk());
//
// 		verify(paymentService).order(any(JSONObject.class));
// 	}
//
// 	@Test
...
// 		ReadBillLogResponse expectedResponse = new ReadBillLogResponse();
//
// 		when(paymentService.cancel(any(JSONObject.class))).thenReturn(expectedResponse);
//
...
// 			.andExpect(status().isOk());
//
// 		verify(paymentService).cancel(any(JSONObject.class));
// 	}
//
// 	@Test
...
// 			.andExpect(content().string("Canceled"));
//
// 		verify(paymentService).refund(any(CreateCancelBillLogRequest.class), any(HttpServletRequest.class));
// 	}
//
// 	@Disabled
// 	@Test
