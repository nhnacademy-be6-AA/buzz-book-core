...
import store.buzzbook.core.elastic.repository.AuthorDocumentRepository;
import store.buzzbook.core.elastic.repository.BookDocumentRepository;
import store.buzzbook.core.elastic.repository.CategoryDocumentRepository;
import store.buzzbook.core.elastic.repository.PublisherDocumentRepository;
import store.buzzbook.core.elastic.repository.TagDocumentRepository;
